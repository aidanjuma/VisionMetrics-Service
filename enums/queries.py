...
class FixedDBQuery(enum.Enum):
    ...
    AFTER
                                                                   ...
                                                                   BEGIN
                                                                   UPDATE use_case
                                                                   SET position_in_queue = (SELECT COALESCE(MAX(position_in_queue), 0) + 1
                                                                                            FROM use_case
    ...
    WRITE_SYSTEM_INFO_RECORD = '''
                               INSERT INTO system_info (ram_capacity,
                                                        disk_capacity,
                                                        total_vram_capacity_mib)
                               VALUES (?, ?, ?); \
                               '''
    ...
    WRITE_CPU_INFO_RECORD = '''
                            INSERT INTO cpu_info (system_id,
                                                  model_name,
                                                  cores,
                                                  min_frequency,
                                                  max_frequency)
    ...
    WRITE_GPU_INFO_RECORD = '''
                            INSERT INTO gpu_info (system_id,
                                                  bus_id,
                                                  model_name,
                                                  vram_capacity_mib)
                            VALUES (?, ?, ?, ?); \
