...
if __name__ == '__main__':
    ...
    system_info_record = (system_info.ram_capacity,
                          system_info.disk_capacity, system_info.total_vram_capacity)

    # Write memory-relayed information to disk:
    connector.execute_query(
        FixedDBQuery.WRITE_SYSTEM_INFO_RECORD, system_info_record)
    latest_system_id: int = int(connector.execute_query(
        ...
        while True:
            ...
            for record in status_records:
                ...
                record.session_id = int(
                    session_id_result[0][0]) if session_id_result is not None else None
                ...
                connector.execute_query(
                    FixedDBQuery.WRITE_GPU_STATUS_RECORD, status_record)
